...
tokens = ['COMA', 'SEMICOLON', 'COLON', 'MULTIPLICATION', 'ADDITION',
          ...
          'CTEINT', 'CTEFLOAT', 'CTECHAR'] + list(reserved.values())
...
def p_acceso_arr(p):
    ...
    if scope == 'Funcion' :
        ...
        pTipos.pop()
        if p[-3] in dir_arr_globales.keys() :
            if dir_arr_locales[p[-3]]['Tipo'] == 'INT ARR' :
                pTipos.append(INT)
            elif dir_arr_locales[p[-3]]['Tipo'] == 'FLOAT ARR' :
                pTipos.append(FLOAT)
            elif dir_arr_locales[p[-3]]['Tipo'] == 'CHAR ARR' :
                pTipos.append(CHAR)
            elif dir_arr_locales[p[-3]]['Tipo'] == 'BOOL ARR' :
                pTipos.append(BOOL)
        elif p[-3] in dir_arr_locales_funciones.keys() :
            if dir_arr_locales[p[-3]]['Tipo'] == 'INT ARR' :
                pTipos.append(INT)
            elif dir_arr_locales[p[-3]]['Tipo'] == 'FLOAT ARR' :
                pTipos.append(FLOAT)
